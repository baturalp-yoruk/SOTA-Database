        ...
        <?php
            ...
            if ($conn->connect_error) {
                ...
                if ($result->num_rows > 0) {
                    ...
                    ?>
                    <form action="DeletePaperResult.php" method="post">
                    ...
                    ?>
						Are you sure you want to delete the following paper? <br />
                        ...
                        <p>Abstract: <input type="text" name="abstract" value = "<?php echo $row["abstract"] ?>" readonly /></p>
                        <p>Result: <input type="text" name="result" value = "<?php echo $row["result"] ?>" readonly /></p>
